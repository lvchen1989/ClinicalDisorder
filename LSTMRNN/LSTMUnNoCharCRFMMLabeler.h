/*
 * LSTMUnNoCharCRFMMLabeler.h
 *
 *  Created on: 2016-4-4
 *      Author: chen_lyu
 */

#ifndef LSTMUNNOCHARCRFMMLABELER_H_
#define LSTMUNNOCHARCRFMMLABELER_H_


#include "N3L.h"
#include "basic/LSTMUnNoCharCRFMMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  LSTMUnNoCharCRFMMClassifier<gpu> m_classifier;
#else
  LSTMUnNoCharCRFMMClassifier<cpu> m_classifier;
#endif
...
#endif /* LSTMUNNOCHARCRFMMLABELER_H_ */
