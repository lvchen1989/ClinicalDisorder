/*
 * LSTMNoCharCRFMMClassifier.h
 *
 *  Created on: 2016-4-3
 *      Author: chen_lyu
 */

#ifndef LSTMNOCHARCRFMMCLASSIFIER_H_
#define LSTMNOCHARCRFMMCLASSIFIER_H_
...
class LSTMNoCharCRFMMClassifier {
public:
  LSTMNoCharCRFMMClassifier() {
    _dropOut = 0.5;
  }
  ~LSTMNoCharCRFMMClassifier() {
...
#endif /* LSTMNOCHARCRFMMCLASSIFIER_H_ */
