/*
 * LSTMNoCharCRFMMLabeler.h
 *
 *  Created on: 2016-4-3
 *      Author: chen_lyu
 */

#ifndef LSTMNOCHARCRFMMLABELER_H_
#define LSTMNOCHARCRFMMLABELER_H_


#include "N3L.h"
#include "basic/LSTMNoCharCRFMMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  LSTMNoCharCRFMMClassifier<gpu> m_classifier;
#else
  LSTMNoCharCRFMMClassifier<cpu> m_classifier;
#endif
...
#endif /* LSTMNOCHARCRFMMLABELER_H_ */
